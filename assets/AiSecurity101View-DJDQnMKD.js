...
`,u=[`innerHTML`],d=s({__name:`AiSecurity101View`,setup(s){let d=e(`markdownit`),f={},p=d.render(l,f),m=n(f.frontmatter.title);return(e,n)=>(o(),r(`div`,null,[i(c,{pageTitle:m.value},null,8,[`pageTitle`]),t(`div`,{innerHTML:a(p),class:`mx-10`},null,8,u)]))}},[[`__scopeId`,`data-v-a7f6894c`]]);export{d as default};