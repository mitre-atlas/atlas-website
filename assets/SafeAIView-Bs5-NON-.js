import{E as e,d as t,dt as n,m as r,vt as i,y as a,z as o}from"./runtime-core.esm-bundler-CamfpX4o.js";import{t as s}from"./_plugin-vue_export-helper-CRt-r6Cj.js";import{t as c}from"./PageSectionTitle-d7WUGGtZ.js";var l=`---
...
To effectively manage the threat landscape, SAFE-AI recommends controls from the NIST control catalog, Special Publication 800-53, Rev 5 and provides a discussion of residual risk for planning potential mitigations.\xA0
...
`,u=[`innerHTML`],d=s({__name:`SafeAIView`,setup(s){let d=e(`markdownit`),f={},p=d.render(l,f),m=n(f.frontmatter.title);return(e,n)=>(o(),r(`div`,null,[a(c,{pageTitle:m.value},null,8,[`pageTitle`]),t(`div`,{innerHTML:i(p),class:`markdown-content mx-0 mx-md-10`},null,8,u)]))}},[[`__scopeId`,`data-v-192351f2`]]);export{d as default};