...
`,u=[`innerHTML`],d=s({__name:`AiSecurity101View`,setup(s){let d=e(`markdownit`),f={},p=d.render(l,f),m=n(f.frontmatter.title);return(e,n)=>(o(),r(`div`,null,[a(c,{pageTitle:m.value},null,8,[`pageTitle`]),t(`div`,{innerHTML:i(p),class:`markdown-content mx-0 mx-md-10`},null,8,u)]))}},[[`__scopeId`,`data-v-62a2b217`]]);export{d as default};