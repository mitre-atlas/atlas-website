...
`,u=[`innerHTML`],d=s({__name:`AiSecurity101View`,setup(s){let d=t(`markdownit`),f={},p=d.render(l,f),m=a(f.frontmatter.title);return(t,a)=>(e(),i(`div`,null,[o(c,{pageTitle:m.value},null,8,[`pageTitle`]),r(`div`,{innerHTML:n(p),class:`mx-10`},null,8,u)]))}},[[`__scopeId`,`data-v-a7f6894c`]]);export{d as default};