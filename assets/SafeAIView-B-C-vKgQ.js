import{L as e,T as t,_t as n,d as r,m as i,ut as a,y as o}from"./runtime-core.esm-bundler-CC_EXLrO.js";import{t as s}from"./_plugin-vue_export-helper-BJ1fRKRD.js";import{t as c}from"./PageSectionTitle-7kjSinF_.js";var l=`---
...
`,u=[`innerHTML`],d=s({__name:`SafeAIView`,setup(s){let d=t(`markdownit`),f={},p=d.render(l,f),m=a(f.frontmatter.title);return(t,a)=>(e(),i(`div`,null,[o(c,{pageTitle:m.value},null,8,[`pageTitle`]),r(`div`,{innerHTML:n(p),class:`mx-10`},null,8,u)]))}},[[`__scopeId`,`data-v-042cb867`]]);export{d as default};