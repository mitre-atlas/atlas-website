import{_ as d}from"./PageSectionTitle.vue_vue_type_script_setup_true_lang-CMwUPSeH.js";import{r as h,D as u,z as p,q as s,g as m,F as g,s as f,o as r,b as o,v as y}from"./index-Dsx3H1jc.js";const v=`---
...
`,b={class:"text-h5 mt-10 mb-5"},A=["innerHTML"],S={__name:"FAQView",setup(M){const c=h("FAQ"),l=p("markdownit"),a=u([]);return Object.values(Object.assign({"/public/content/faq-files/case-study-terms.md":v,"/public/content/faq-files/contact.md":T,"/public/content/faq-files/general.md":_,"/public/content/faq-files/mitigation-terms.md":w})).map(t=>{const e={},n=l.render(t,e),i={frontmatter:e.frontmatter,content:n};a.push(i)}),a.sort((t,e)=>"weight"in t.frontmatter&&"weight"in e.frontmatter?t.frontmatter.weight-e.frontmatter.weight:"title"in t.frontmatter&&"title"in e.frontmatter?t.frontmatter.title.localeCompare(e.frontmatter.title):t-e),(t,e)=>(r(),s("div",null,[m(d,{pageTitle:c.value},null,8,["pageTitle"]),(r(!0),s(g,null,f(a,(n,i)=>(r(),s("div",{key:i},[o("div",b,y(n.frontmatter.title),1),o("div",{innerHTML:n.content},null,8,A)]))),128))]))}};export{S as default};
