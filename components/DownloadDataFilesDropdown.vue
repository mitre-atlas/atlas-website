...
<v-menu offset-y>
            ...
            <v-list>
              <v-list-item>
                  ...
                  @click="makePPT"
                  style="color: inherit"
                  >Download Powerpoint</a><v-icon
                      small
                    >mdi-arrow-collapse-down</v-icon>
              </v-list-item>
              <v-list-item>
                  <a
                  @click="saveFile($config.individual_case_study.yaml_raw_link, study.id, $config.individual_case_study.yaml_file_suffix)"
                  style="color: inherit"
                  >Download YAML</a><v-icon
                      small
                    >mdi-arrow-collapse-down</v-icon>
              </v-list-item>
            </v-list>
