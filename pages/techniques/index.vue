...
export default {
  data: ({ $config: { name } }) => ({
    title: 'Techniques',
    description: 'The table below lists techniques from MITRE ' + name.short + ' and ATT<span class="red--text text--darken-3">&</span>CK<sup>&reg;</sup> Enterprise. Scroll through the table or use the filters to narrow down the information.'
  }),
  computed: {
