<template>
  <div>
    ...
    <h4>Information Collected from Cookies on Web Traffic Reporting and Content Tools</h4>
    <p>
    ...
    <p>
      Users may contact MITRE electronically, via <a href="mailto:atlas@mitre.org">atlas@mitre.org</a>.
