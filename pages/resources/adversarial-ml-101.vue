...
<div>
  ...
  <p>
    Head over to the <NuxtLink to="/matrix">MITRE {{ $config.name.short}}<sup>&trade;</sup> Matrix</NuxtLink> page to see a compendium of attacks in MITRE ATT&CK<sup>&reg;</sup> style.
  </p>
