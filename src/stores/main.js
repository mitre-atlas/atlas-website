...
// other options...
    getters: {
      ...
      getDataObjectsByTypeKeyValue:
        function(state) { return function (objType, key, value, matrixId) {
      ...
      getDataObjectsByTypeKeyValueDeepCopyDefault:
        function(state) { return function (objType, key, value, matrixId) {
          ...
          let objs = this.getDataObjectsByTypeKeyValue(
            objType,
            key,
            value,
            matrixId
      ...
      getDataObjectByIdDeepCopyDefault: function (state) {
        return function (value) { // Returns a deep copy of the the data object with the corresponding ID, with only default data keys present
    ...
    actions: {
      ...
      async init() {
        ...
        const promise = Promise.resolve(yamlString).then(contents => {
          ...
          this.SET_OBJECT_TYPE_PLURAL_VALUES(
