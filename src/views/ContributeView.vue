<template>
  <div class="ma-3 ma-md-0">
    <v-container class="text-mediumNavy pt-sm-16 mt-sm-16">
      ...
      <v-row>
        <v-col cols="12" sm="8">
          <p>
            {{ MITRE_TITLE }} is a continuously growing and evolving knowledge base of how AI
            systems can be attacked. Its strength comes in large part from the community that fuels
            it, and that’s where you come in! By sharing your insights, you’ll help make the
            knowledge base holistic, up-to-date, and ready for the next wave of AI threats.
          </p>
          <p style="font-size: 20px; font-weight: 500" class="mb-0 mt-12">
            Have a fresh tactic, a clever technique, or a new mitigation? Perhaps a combination?
            Send it our way! While all contributions to ATLAS are appreciated, we’re especially
            interested in:
          </p>
        </v-col>
  ...
  <div class="ma-3 ma-md-0">
    ...
    <div class="text-center my-16 py-sm-16">
      <div class="text-h5 text-darkInfo font-weight-bold">
        Thank you for your contribution and expertise!
      </div>
